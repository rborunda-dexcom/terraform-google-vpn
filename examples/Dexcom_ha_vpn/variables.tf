...
variable "project1_project_id" {
  description = "Production Project ID."
  type        = string
  default = "project1-330918"
}

variable "project1_network_self_link" {
...
variable "project1_vpn_name" {
  description = ""
  type        = string
  default = ""ha-vpn-project2-to-project1""
}


variable "project1_asn"{
  description = ""
  type        = number
  default     = 64514"
}
...
variable "project2_project_id" {
  description = "Management Project ID."
  type        = string
  default = "project2-330918"
}

variable "project2_network_self_link" {
